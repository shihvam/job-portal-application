          ...
          <div className='container m-auto p-0' >
            <div className='flex items-center flex-wrap gap-12 lg:gap-0' >
                <div className='lg:w-5/12 space-y-8' >
                  ...
                  <h1 className='text-4xl font-bold md:text-6xl'> The Best <br/>Job Portal App </h1>
                  <p className='text-xl text0gray-700' >Find best jobs from top product based companies and build your career  </p>
